                            ...
                            'needs-validation']) !!}
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <option value="{{$student->province}}" selected>{{$student->province}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description1"
                                        class="summernote form-control">{{$student->description1}}</textarea>
                                </div>
                                <div class="form-group">
                                    <h3><label for="description2">ระบุความต้องการของนักเรียน</label></h3>
                                    <textarea name="description2"
                                class="summernote form-control" >{{$student->description2}}</textarea>
                                </div>
                                <div class="form-group">
