                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item"
                                                ...
                                                <i data-feather="edit-2" class="icon-sm mr-2"></i><span class="">
                                                    แก้ไขข้อมูล</span>
                                            </a>
                                        ...
                                        @if ($s->closeDonate < now()) <a href="#" class="btn btn-secondary "
                                            data-toggle="tooltip" data-placement="left" title="เพิ่มคำขอบคุณ"><i
                                                class="icon-md" data-feather="edit-3"></i></a>
                                            @endif
